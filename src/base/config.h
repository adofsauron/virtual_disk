...
namespace config
{
	...
	static const uint64    CONST_MAX_SIZE_DISK_TOTAL		= 200 * 1024 * 1024;                    // 总磁盘空间, 200M
	...
	static const char*     CONST_DISK_MIRROR_NAME           = "./mirror/virtual_disk.data";         // 虚拟磁盘被序列化后存储的文件名称
	static const char*     CONST_LOG_FILE_NAME              = "vdisk";                              // 日志文件名称,后边需追加年月日时分秒_4位随机数
