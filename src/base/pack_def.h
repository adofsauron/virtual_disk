...
typedef struct SCateNode // 目录树节点
{
	...
	uint32				m_i_id;											// 节点id
	char				m_p_name[config::CONST_MAX_SIZE_FILE_NAME + 1];	// 绝对路径+文件名
